...
5. [Aba "Tabela Dinâmica" — o coração do programa](#5-aba-tabela-dinâmica--o-coração-do-programa)
6. [Aba "Dashboard" — o resumo visual das suas finanças](#6-aba-dashboard--o-resumo-visual-das-suas-finanças)
7. [Exportando para Excel e CSV](#7-exportando-para-excel-e-csv)
8. [Onde ficam seus dados e como fazer backup](#8-onde-ficam-seus-dados-e-como-fazer-backup)
9. [Perguntas frequentes e dicas](#9-perguntas-frequentes-e-dicas)
...
Sim, mas cada "perfil" precisa da sua própria cópia da pasta do programa (cada cópia tem seu próprio `dados.db`). Não há, hoje, um seletor de "múltiplos perfis" dentro do próprio programa.
